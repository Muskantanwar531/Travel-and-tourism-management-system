...
public class AddCustomer extends JFrame {
	...
	public AddCustomer(String username) throws SQLException {
		...
		lblName.setFont(new Font("Lucida Calligraphy", Font.PLAIN, 20));
		...
		contentPane.add(lblGender);
                ...
                r1.setBackground(new Color(193,202,217));
                r1.setBounds(271, 230, 80, 12);
                add(r1);

                r2 = new JRadioButton("Female");
                r2.setFont(new Font("Raleway", Font.BOLD, 14));
                r2.setBackground(new Color(193,202,217));
		...
		JLabel lblCheckInStatus = new JLabel("Phone No. :");
		...
		contentPane.add(btnExit);
                ...
                getContentPane().setBackground(new Color(193,202,217));
	}
